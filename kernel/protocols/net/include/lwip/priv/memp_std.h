...
LWIP_PBUF_MEMPOOL(PBUF_POOL, PBUF_POOL_SIZE, PBUF_POOL_BUFSIZE + LWIP_XR_EXT_MBUF_HEAD_SPACE + LWIP_XR_EXT_MBUF_TAIL_SPACE, "PBUF_POOL")
#if LWIP_XR_EXT_PBUF_POOL_SMALL
LWIP_PBUF_MEMPOOL(PBUF_POOL_SMALL, LWIP_XR_EXT_PBUF_POOL_SMALL_SIZE, LWIP_XR_EXT_PBUF_POOL_SMALL_BUFSIZE + LWIP_XR_EXT_MBUF_HEAD_SPACE + LWIP_XR_EXT_MBUF_TAIL_SPACE, "PBUF_POOL_SMALL")
