...
/* enable embedded synchronization mode */
void dci_embedded_sync_enable(void);
/* disble embedded synchronization mode */
void dci_embedded_sync_disable(void);
/* config synchronization codes in embedded synchronization mode */
void dci_sync_codes_config(uint8_t frame_start, uint8_t line_start, uint8_t line_end, uint8_t frame_end);
/* config synchronization codes unmask in embedded synchronization mode */
