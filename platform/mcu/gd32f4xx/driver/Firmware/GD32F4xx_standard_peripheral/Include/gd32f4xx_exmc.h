...
#define EXMC_CLOCK_UNCONDITIONALLY          ((uint32_t)0x00100000U)       /*!< EXMC_CLK is generated unconditionally */
...
#define EXMC_SDRAM_DEVICE0_SELECT           ((uint32_t)0x00000010U)       /*!< SDRAM device0 select */

/* SDRAM device1 select */
#define EXMC_SDRAM_DEVICE1_UNSELECT         ((uint32_t)0x00000000U)       /*!< SDRAM device1 unselect */
#define EXMC_SDRAM_DEVICE1_SELECT           ((uint32_t)0x00000008U)       /*!< SDRAM device1 select */
...
#define EXMC_SQPIPSRAM_SAMPLE_FALLING_EDGE  ((uint32_t)0x80000000U)       /*!< sample data at falling edge */
