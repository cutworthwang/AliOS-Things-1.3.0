...
/*!
    \brief      enable embedded synchronization mode
    \param[in]  none
    \param[out] none
    \retval     none
*/
...
/*!
    \brief      disble embedded synchronization mode
    \param[in]  none
    \param[out] none
    \retval     none
*/
...
/*!
    \brief      config synchronization codes in embedded synchronization mode 
...
/*!
    \brief      config synchronization codes unmask in embedded synchronization mode
