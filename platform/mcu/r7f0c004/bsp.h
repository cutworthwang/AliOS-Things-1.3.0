...
#define  REG_PR00H                     (*(volatile uint8_t __far*)0x000FFFE9u)
#define  REG_PR10H                     (*(volatile uint8_t __far*)0x000FFFEDu)
#define  REG_PR01L                     (*(volatile uint8_t __far*)0x000FFFEAu)
#define  REG_PR11L                     (*(volatile uint8_t __far*)0x000FFFEEu)

#define  REG_IF0H                      (*(volatile uint8_t __far*)0x000FFFE1u)
#define  REG_MK0H                      (*(volatile uint8_t __far*)0x000FFFE5u)
