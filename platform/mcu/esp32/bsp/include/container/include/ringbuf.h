 ...
 */
int xRingbufferSend(RingbufHandle_t ringbuf, void *data, size_t data_size, espos_tick_t ticks_to_wait);
 ...
 */
int xRingbufferSendFromISR(RingbufHandle_t ringbuf, void *data, size_t data_size, int *higher_prio_task_awoken);
 ...
 */
void *xRingbufferReceive(RingbufHandle_t ringbuf, size_t *item_size, espos_tick_t ticks_to_wait);
 ...
 *         item. NULL on timeout, *item_size is untouched in that case.
 */
void *xRingbufferReceiveUpTo(RingbufHandle_t ringbuf, size_t *item_size, espos_tick_t ticks_to_wait, size_t wanted_size);
 ...
 * @return void
 */
void vRingbufferReturnItemFromISR(RingbufHandle_t ringbuf, void *item, int *higher_prio_task_awoken);
...
//  */
// int xRingbufferAddToQueueSetRead(RingbufHandle_t ringbuf, QueueSetHandle_t xQueueSet);
...
//  * @return pdTRUE on success, pdFALSE otherwise
//  */
// int xRingbufferAddToQueueSetWrite(RingbufHandle_t ringbuf, QueueSetHandle_t xQueueSet);
...
//  * @return pdTRUE on success, pdFALSE otherwise
//  */
// int xRingbufferRemoveFromQueueSetRead(RingbufHandle_t ringbuf, QueueSetHandle_t xQueueSet);
...
//  * @return pdTRUE on success, pdFALSE otherwise
//  */
// int xRingbufferRemoveFromQueueSetWrite(RingbufHandle_t ringbuf, QueueSetHandle_t xQueueSet);
