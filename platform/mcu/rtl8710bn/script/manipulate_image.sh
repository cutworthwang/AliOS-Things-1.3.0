...
#cp $(test_dir)/component/soc/realtek/8711b/misc/bsp/image/boot_all.bin $(BIN_DIR)/boot_all.bin
...
#grep_cmd_start=grep __ram_image2_text_start__ ${BIN_DIR}/${outputname}.nmap
#grep_cmd_end=grep __ram_image2_text_end__ ${BIN_DIR}/${outputname}.nmap
#gawk_cmd=gawk '{print $1}'
