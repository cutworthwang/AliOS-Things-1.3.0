...
void rtw_exit_critical_from_isr(plock,pirqL); 
    ...
    #define  rtw_enter_critical_from_isr(plock,pirqL) {cpsr =cpu_intrpt_save();}
    #define  rtw_exit_critical_from_isr(plock,pirqL)   {cpu_intrpt_restore(cpsr);}
