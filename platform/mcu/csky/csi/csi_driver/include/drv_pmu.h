...
/****** PMU Event *****/
typedef enum {
    PMU_EVENT_WAKEUP_DONE       = 0,  ///< Send completed; however PMU may still transmit data
} pmu_event_e;

typedef void (*pmu_event_cb_t)(int32_t idx, pmu_event_e event);   ///< Pointer to \ref pmu_event_cb_t : PMU Event call back.
