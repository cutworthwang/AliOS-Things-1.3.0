...
#define PLL_M          13                       /* PLLM = 16                            */
#define PLL_N          192                      /* PLLN = 400                           */
#define PLL_P          4                        /* PLLP = 4                             */
#define PPL_Q          8                        /* PLLQ = 8                             */
#define PPL_R          2                        /* PLLR = 2                             */
...
#else
  SCB->VTOR = 0x08008000 | VECT_TAB_OFFSET; /* Vector Table Relocation in Internal FLASH */
#endif
}
