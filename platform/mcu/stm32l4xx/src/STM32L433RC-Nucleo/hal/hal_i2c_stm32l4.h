...
#define I2C1_SDA_GPIO_CLK_ENABLE()         __HAL_RCC_GPIOA_CLK_ENABLE()
#define I2C1_SCL_GPIO_CLK_ENABLE()         __HAL_RCC_GPIOA_CLK_ENABLE()
#define I2C1_SDA_GPIO_CLK_DISABLE()        __HAL_RCC_GPIOA_CLK_DISABLE()
#define I2C1_SCL_GPIO_CLK_DISABLE()        __HAL_RCC_GPIOA_CLK_DISABLE()
