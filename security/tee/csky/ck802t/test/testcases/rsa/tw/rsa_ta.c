...
static TEE_Result _RSA_Test_OpenSessionEntryPoint(
        uint32_t paramTypes,
        TEE_Param params[4],
        void **sessionContext)
{
...
static TEE_Result _RSA_Test_InvokeCommandEntryPoint(
        void *sessionContext,
        uint32_t commandID,
        uint32_t paramTypes,
        TEE_Param params[4])
...
TEE_SRV_DATA_START(_RSA_Test_CreateEntryPoint,
        _RSA_Test_DestroyEntryPoint,
