...
#if defined(LWS_WITH_ESP32) ||defined(LWS_WITH_AOS)
...
struct lws_vhost {
	...
	const char *name;
	const char *iface;
#if !defined(LWS_WITH_ESP8266) && !defined(LWS_WITH_ESP32) && !defined(OPTEE_TA) && !defined(WIN32) && !defined(LWS_WITH_AOS)
	int bind_iface;
#endif
...
#if LWS_POSIX && !defined(LWS_WITH_ESP32) && !defined(LWS_WITH_AOS)
