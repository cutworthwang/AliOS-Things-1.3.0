...
typedef enum {
    ...
    dm_subdev_callback_type_new_thing_created,
    dm_subdev_callback_type_thing_disabled,
    dm_subdev_callback_type_thing_enabled,
    dm_subdev_callback_type_raw_data_arrived,
    dm_subdev_callback_type_linkkit_data_arrived,

    dm_subdev_callback_type_number,
} dm_subdev_callback_type_t;


typedef void (*handle_dm_subdev_callback_fp_t)(dm_subdev_callback_type_t callback_type, void* sub_thing_id, int id, int code, char* message,
                                               void* raw_data, int raw_data_length, void *param, int param_length);
...
#ifdef SUBDEV_ENABLE
    void* (*generate_new_subthing)(void* _self, const char* product_key, const char* device_name, const char* device_secret, const char* tsl, int tsl_len);
