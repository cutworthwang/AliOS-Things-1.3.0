...
#ifndef LV_CONF_STARTERKIT_H
#define LV_CONF_STARTERKIT_H
...
#if LV_MEM_CUSTOM == 0
#define LV_MEM_SIZE    (1U * 1024U)        /*Size memory used by mem_alloc (in bytes)*/
...
#define LV_VDB_SIZE         (1 * 1024)  /*Size of VDB in pixel count*/
